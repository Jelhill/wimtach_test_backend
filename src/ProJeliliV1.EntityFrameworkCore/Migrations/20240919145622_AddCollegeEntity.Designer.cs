...
namespace ProJeliliV1.Migrations
{
    ...
    [Migration("20240919145622_AddCollegeEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProJeliliV1.Models.College", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("JeliliString")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ProJeliliV1.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ProJeliliV1.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ProJeliliV1.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ProJeliliV1.Models.Student", b =>
                {
                    b.HasOne("ProJeliliV1.Models.College", null)
                        .WithMany("Students")
