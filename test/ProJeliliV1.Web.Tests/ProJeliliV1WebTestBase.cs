...
{
    public abstract class ProJeliliV1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProJeliliV1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProJeliliV1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProJeliliV1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProJeliliV1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProJeliliV1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProJeliliV1DbContext, Task<T>> func)
        {
            T result;
